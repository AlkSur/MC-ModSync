...
PUBLIC_BASE = "default-u1w7cnqz.cdn.7caiyun.com"
...
def main() -> int:
    ...
    ap.add_argument("--pack-id", default="zdjxd")
    ap.add_argument("--pack-name", default="打金小队整合包")
    ...
    ap.add_argument("--bucket", default="default-u1w7cnqz")
